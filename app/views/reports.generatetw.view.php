...
<form action="" method="post" style="width:90%;margin-left:auto;margin-right:auto;">
    <h3>TW Or TWA Books</h3>
    <?php if($rows):?>
    <table class="print-table">
        <tr><th>ISBN</th><th>copy_id</th><th>Author</th><th>Title</th><th>Call Number</th><th>Language Code</th>
        </tr>
    ...
    <a class="update_profile_button" href="<?=ROOT?>/reports/tw">Cancel
        <?php else:?>
