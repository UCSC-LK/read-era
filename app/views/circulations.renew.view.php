...
<div class="crumbs">
        ...
        <div class="content-box">
            <div class="box1 box">
                <div class="title">Renew</div><br>
                
                <div class="container">
                <form method="post">
                    <div class="title"><h5 style="color:black;">Renew details</h5></div><br>
                    <div class="row">
                    <div class="col-25">
                    ...
                    <br><div>Make sure that the fine amount has been settled before Renewal.<div><br><br>
                    <div class="row">
                    

                    <a href="<?=ROOT?>/circulations"><input type="submit" value="renew">
