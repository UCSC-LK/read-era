...
<div class="crumbs">
    ...
    <div class="content-box">
        <div class="box1 box">
            <div class="header">
                <div class="title">Withdrawn Books</div>
            </div>
            <?php if($rows):?>
            <table class="table table-striped table-hover">
                <tr><th>ISBN</th><th>Copy</th><th>Author</th><th>Title</th><th>Call Number</th><th>Language Code</th>
                </tr>
            ...
            <?php else:?>
                <h4>No withdrawn books were found at this time</h4>
            <?php endif;?>
            <a href="<?=ROOT?>/reports/generatew" class="update_profile_button">Generate</a>
