...
<section class="main">
  ...
  <div class="maind">
    <p class="sign" align="center">Verify Your Mail</p>
    ...
    <span style="font-size: 12px;color:red;padding-left:47px;">
      ...
      <p class="label">Please Enter The Digit Code Sent To Your Mail<br></p><br>
      <label class="label1">Enter The Code:<br></label><br>
      <input class="pass" type="text" name="code" value="<?=get_var('code')?>" placeholder="12345"><br>
